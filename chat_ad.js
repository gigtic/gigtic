...
const target = `{/* Messages Area */}
      <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-6 relative flex flex-col pt-8">`;

const replacement = `{/* Discreet Ad Unit Below Header */}
      <div className="w-full flex justify-center bg-gray-50 border-b border-gray-200 py-2 shrink-0">
      ...
      {/* Messages Area */}
      <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-6 relative flex flex-col pt-4">`;
