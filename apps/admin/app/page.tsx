  ...
  if (!isAuthorized) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center">
        ...
        <p className="text-gray-500 mt-2 mb-8">Internal personnel only. Please sign in with an authorized account.</p>
        ...
        <button
          ...
          className="flex items-center justify-center gap-3 py-3 px-6 border border-gray-200 rounded-xl text-sm font-semibold text-gray-700 bg-white hover:bg-gray-50 transition-all shadow-sm"
        >
