...
import { Loader2, ShieldAlert, TrendingUp, Users, Activity, DollarSign, Server, CheckCircle2, BarChart3, MousePointerClick, Eye, IndianRupee, Search, KeyRound, Webhook, Link2, Shield, Trash2, Plus, Megaphone, Star, X } from 'lucide-react';
  ...
  return (
    <div className="font-sans animate-in fade-in duration-500">
      ...
      <div className="flex md:hidden space-x-2 mb-6 bg-slate-100 p-1 rounded-xl w-full overflow-x-auto no-scrollbar">
        {["overview", "adsterra_ads", "user_management", "reviews", "push_notifications", "reports_&_issues", "database", "api_management", "access_control"].map(tab => (
          <button 
            key={tab}
